...
export type Difficulty = InferSelectModel<typeof difficulty>
...
export type InsertDifficulty = InferInsertModel<typeof difficulty>
...
export type UpdateRecipeData = Partial<
  Omit<InsertRecipe, "id" | "userId" | "createdAt">
>
...
export type UpdateReviewData = Partial<
  Omit<InsertReview, "id" | "userId" | "recipeId" | "createdAt">
>
