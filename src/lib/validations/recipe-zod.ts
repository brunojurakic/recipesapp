  ...
  instructions: z
    .array(
      z.object({
        ...
        content: z
          .string()
          .min(5, "Sadržaj upute mora imati najmanje 5 znakova"),
      }),
    )
    .min(1, "Potrebna je barem jedna uputa"),
  categories: z
    .array(z.string().uuid())
    .min(1, "Potrebna je barem jedna kategorija"),
  ingredients: z
    .array(
      z.object({
        name: z
          .string()
          .min(2, "Naziv sastojka mora imati najmanje 2 znaka")
          .max(50, "Naziv sastojka može imati najviše 50 znakova"),
        quantity: z
          .number({
