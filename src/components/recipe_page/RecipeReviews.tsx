  ...
  return (
    <Card className='shadow-xl'>
      ...
      <CardContent>        <div className="space-y-6">
          {reviews.map((review) => (            <div key={review.id} className="border-b pb-4 last:border-0 last:pb-0">
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="flex items-center gap-2">
                  {currentUserId && currentUserId === review.userId && (
                    <EditReviewDialog review={review} onReviewUpdated={handleReviewUpdated} />
                  )}
                  <div className="flex">
