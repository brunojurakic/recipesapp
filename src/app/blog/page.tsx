...
export const metadata: Metadata = {
  ...
  description: 'Pročitajte naše najnovije članke o kulinarstvu, receptima i kuharskim trikovima. Otkrijte savjete i inspiracije za vašu kuhinju.',
  keywords: ['blog', 'kulinarski članci', 'recepti', 'kuharstvo', 'savjeti', 'trikovi'],
};
      ...
      <div className="mb-8 flex justify-between items-start">
        <div>
          ...
          <p className="text-lg text-muted-foreground max-w-2xl">
            Pratite naše članke o kulinarstvu i poboljšajte svoje vještine u kuhinji
          </p>
        </div>
